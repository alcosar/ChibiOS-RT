...
/**
 * @file    GCC/ARMCMx/LM4F/vectors.c
 * @brief   Interrupt vectors for the LM4F family.
 *
 * @defgroup ARMCMx_LM4F_VECTORS LM4F Interrupt Vectors
 * @ingroup ARMCMx_SPECIFIC
 * @details Interrupt vectors for the LM4F family.
 * @{
 */
...
extern void Vector1AC(void);
extern void Vector1B0(void);
extern void Vector1B4(void);
extern void Vector1B8(void);
extern void Vector1BC(void);
extern void Vector1C0(void);
extern void Vector1C4(void);
extern void Vector1C8(void);
extern void Vector1CC(void);
extern void Vector1D0(void);
extern void Vector1D4(void);
extern void Vector1D8(void);
extern void Vector1DC(void);
extern void Vector1E0(void);
extern void Vector1E4(void);
extern void Vector1E8(void);
extern void Vector1EC(void);
#endif

/**
 * @brief   LM4F vectors table.
 */
#if !defined(__DOXYGEN__)
